...
<template>
  <div class="p-4">
    <h2 class="spending-title mb-8 text-2xl font-bold">{{ $t('消費趨勢') }}</h2>
    <h3 class="mb-2">{{ $t('花費') }}</h3>
    <h1 class="my-4 text-3xl font-bold">-$1257.32</h1>
    <p class="font-normal text-bank-gray-800">{{ $t('最近30天') }}<span class="m-2 text-bank-green-300">+30%</span></p>
